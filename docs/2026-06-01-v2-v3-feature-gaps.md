...
- [~] **71. Minor edits/defaults.** The two functional items fixed; the cosmetic/preference ones left as accepted deltas.
  ...
  - Left as accepted (cosmetic/preference, not clear regressions): `{{relative_date}}` day-mode ±7 wording (`relative-date.ts:39-40`); decoration "Add style" defaults (transparent color / border sides off / square-middle); shelf-name placeholder "ex. Work". Revisit if a user reports them.
