...
| Heatmap Tracker                       |                          47,790 | **The live successor to Heatmap Calendar**, which #366 and #367 are both built on and which has been dead since 2024-06. Created 2024-11, last commit 2026-09-01, 61 issues. Its open ones are our open questions: cell-click-to-open (#113), per-day styling (#112), unfilled days highlighted (#87), a UTC-vs-local streak off-by-one (#81) | not examined        |
