...
| Heatmap Calendar                      |       174,912 | A year-scale density view. Our decorations are cell-scale only — there is no way to see a year of activity at once                                             | not examined |
...
| Plugin                                     |      Installs | Harvest                                                                                                                                                                     | Status           |
| ------------------------------------------ | ------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| Notebook Navigator                         |       944,711 | A file browser with a calendar built in, styled on Day One. The single biggest mindshare competitor, and the first answer people give when asked for a Calendar replacement | not examined     |
