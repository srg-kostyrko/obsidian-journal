...
2. [Journals](/journals) — set up your first journal: where notes go, what they are called, what goes
   in them.
...
- **Using Journals** — [Questions](/questions), [Notelets](/notelets), [Decorations](/decorations),
  [Commands](/commands)
- **Reference** — [Settings](/settings), [Variables](/reference/variables),
  [Code blocks](/reference/code-blocks), [Glossary](/reference/glossary)
