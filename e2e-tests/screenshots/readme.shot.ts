...
describe("readme screenshots", () => {
  before(async () => {
    await reloadObsidianOn(TODAY, { vault: "./e2e-tests/fixtures/e2e-docs-readme", plugins: ["journals"] }, "09:12:00");
...
describe("readme screenshots — decorations", () => {
  ...
  before(async () => {
    await reloadObsidianOn(
      TODAY,
      { vault: "./e2e-tests/fixtures/e2e-docs-readme-decorations", plugins: ["journals"] },
      "09:12:00",
    );
    await prepareWorkspace();
  });
