...
// Obsidian's own word definition, lifted verbatim from the core `word-count` plugin
// (app.js, Obsidian 1.13.7) so this count matches what the status bar shows. There is
// no public API for it — obsidian.d.ts has no word-count surface at all.
// prettier-ignore
