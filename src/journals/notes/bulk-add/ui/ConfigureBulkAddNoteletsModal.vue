...
// The date is parsed out of the existing note's title or property, which is a journal-level
// format — prefill from the journal, not the notelet type, so a non-ISO journal starts from the
