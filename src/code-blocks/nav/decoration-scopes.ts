...
// v2 scopes the two nav decoration modes differently: a whole-block decoration draws only on
// the current journal's own decorations, while a per-row decoration draws on every journal of
