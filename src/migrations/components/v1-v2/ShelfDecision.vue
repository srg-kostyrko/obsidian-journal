...
<template>
  <div>
    <ObsidianSetting heading name="Use shelfs?" />
    <ObsidianSetting no-controls>
      <template #description>
        ...
        Enabling shelfs before migration will convers all calendar journals that have more than one section eables into
        a shelf.<br />
