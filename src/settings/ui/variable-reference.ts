...
export class VariableReferenceModal extends Modal {
  ...
  display() {
    ...
    if (this.granularity === "day") {
      ...
      div1.createEl("br");
      div1.createSpan({
        text: "You can also use {{start_date:format}} to override format once, and use {{date+5D:format}} to add 5 days.",
      });
      div1.createEl("br");
      div1.createEl("a", {
        text: "Formatting reference.",
      ...
      div2.createEl("br");
      div2.createSpan({
        text: "You can also use {{end_date:format}} to override format once, and use {{date+5D:format}} to add 5 days.",
      });
      div2.createEl("br");
      div2.createEl("a", {
        text: "Formatting reference.",
